                    ...
                    <div class="card-body mt-5">
                        <form method="POST" action="{{ route('Issue.Update',$issue->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="amount" type="text" class="form-control" name="amount" value="{{$issue->amount}}" required autofocus>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="date" type="date" class="form-control" name="date" value="{{$issue->issue_date}}" required>
                                </div>
                                @if ($errors->has('date'))
